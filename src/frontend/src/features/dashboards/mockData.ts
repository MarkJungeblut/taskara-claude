...
export const MOCK_EMPLOYEES: Employee[] = [
  ...
  { id: '3', name: 'Priya Chandrasek',  department: 'Product',        startDate: '2021-01-18T00:00:00', status: 'Remote'   },
  { id: '4', name: 'Jordan Osei',       department: 'Engineering',    startDate: '2018-08-22T00:00:00', status: 'On Leave' },
  { id: '5', name: 'Tatiana Morozova',  department: 'Marketing',      startDate: '2022-03-07T00:00:00', status: 'Contract' },
  ...
  { id: '8', name: 'Dmitri Volkov',     department: 'Infrastructure', startDate: '2020-02-28T00:00:00', status: 'Remote'   },
];
