  ...
  return (
    <header className="sticky top-0 z-50 h-16 flex justify-between items-center px-6 bg-slate-50/80 backdrop-blur-xl border-b border-slate-200">
      <div className="flex items-center gap-8">
        <span className="text-2xl font-bold tracking-tight text-slate-900">Taskara</span>
      ...
      <div className="flex items-center gap-4">
        <div className="relative">
          <input
            ...
            className="pl-4 pr-10 py-2 bg-slate-100 border-none rounded-full text-sm focus:outline-none focus:ring-2 focus:ring-primary/20 w-64"
          />
